        ...
        private void Draw()
        {
                        ...
                        if (isOpened[key])
                        {
                            ...
                            foreach (var data in list)
                            {
                                ...
                                //if (dt != null)
                                {
                                    ...
                                    var selection = GUILayout.Toggle(selectRCode == name, new GUIContent($"{LocaleDataSO.GetString("name_" + name)}({name})"), toggleStyle, GUILayout.Width(170));
            ...
            if (currentAsset != null)
            {
                GUILayout.BeginVertical();
                {
                    ...
                    var baseFields = typeof(BaseData).GetFields().ToList();
